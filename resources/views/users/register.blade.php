    ...
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/users">
            ...
            <div class="mb-6">
                ...
                <input type="password" class="border border-gray-200 rounded p-2 w-full" name="password" value="{{old('password_confirmation')}}" />
            ...
            <div class="mt-8">
                <p>
                    ...
                    <a href="/login" class="text-red-600">Sign in</a>
                </p>
            </div>
        </form>
    </x-card>
