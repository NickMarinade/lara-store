...
<body class="mb-48">
    ...
    <nav class="flex justify-between items-center mb-4">
        ...
        <ul class="flex space-x-6 mr-6 text-lg">
            <li>
                <a href="/register" class="hover:textred-600"><i class="fa-solid fa-user-plus"></i> Sign up</a>
            </li>
            <li>
                <a href="/login" class="hover:textred-600"><i class="fa-solid fa-arrow-right-to-bracket"></i>
                    Log in</a>
            </li>
        </ul>
    </nav>
